...
import com.example.ejemplo2navidgs904.screens.FirstScreen
import com.example.ejemplo2navidgs904.screens.SecondScreen
import com.example.ejemplo2navidgs904.ui.theme.Ejemplo2NavIDGS904Theme
...
fun PantallaInicio(navController: NavHostController){
    ...
    Column(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
        ...
        TextField(value = nombre, onValueChange = {nombre = it}, label = { Text("Ingrese su nombre")}, modifier = Modifier.fillMaxWidth())
        Spacer(modifier = Modifier.height(16.dp))
        Button(onClick = {
